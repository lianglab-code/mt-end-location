function ppout = sum_ppform(pp1,pp2)
%% SUM_PPFORM adds two pp-form piecewise polynomials:
% pp1 with pp2
...
for ii = 1:(num_break-1)
    ...
    num_pc2 = numel(pc2);
    if num_pc1<num_pc2
        pc = [zeros(1,num_pc2-num_pc1),pc1]+pc2;
    else
        pc = pc1 + [zeros(1,num_pc1-num_pc2),pc2];
    end
